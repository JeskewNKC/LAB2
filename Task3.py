...
# Text formatting ignoring simple english words that do not contribute to overall meaning of text
...
# removing numbers from top_grams using zip and converting to list
tg = zip(*(top_grams2))
tg = list(tg)
bg1 = tg[0]
print(bg1)
